...
Route2_Object:
	...
	def_object_events
	object_event 19,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_HP_UP, HP_UP
	object_event 18, 64, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_RARE_CANDY, RARE_CANDY
	object_event 18, 68, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_MOON_STONE, MOON_STONE
