...
ViridianCity_Object:
	...
	warp_event 29, 15, VIRIDIAN_MART, 1
	warp_event 13, 13, VIRIDIAN_SCHOOL_HOUSE, 1
	warp_event 21,  9, VIRIDIAN_NICKNAME_HOUSE, 1
	warp_event 32,  7, VIRIDIAN_GYM, 1

	def_bg_events
	bg_event 23, 13, TEXT_VIRIDIANCITY_SIGN
	bg_event 19,  1, TEXT_VIRIDIANCITY_TRAINER_TIPS1
	bg_event 11, 13, TEXT_VIRIDIANCITY_TRAINER_TIPS2
	bg_event 30, 15, TEXT_VIRIDIANCITY_MART_SIGN
	bg_event 22, 23, TEXT_VIRIDIANCITY_POKECENTER_SIGN
	bg_event 27,  7, TEXT_VIRIDIANCITY_GYM_SIGN

	def_object_events
	object_event 30, 24, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER1
	object_event 30,  8, SPRITE_GAMBLER, STAY, NONE, TEXT_VIRIDIANCITY_GAMBLER1
	object_event 13, 18, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER2
	...
	object_event  5, 22, SPRITE_FISHER, STAY, DOWN, TEXT_VIRIDIANCITY_FISHER
