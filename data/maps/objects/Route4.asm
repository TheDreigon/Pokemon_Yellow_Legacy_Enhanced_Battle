...
Route4_Object:
	...
	def_object_events
	object_event 13, 11, SPRITE_COOLTRAINER_F, WALK, UP_DOWN, TEXT_ROUTE4_COOLTRAINER_F1
	object_event 63,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 38,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_RAZOR_WIND, TM_RAZOR_WIND
