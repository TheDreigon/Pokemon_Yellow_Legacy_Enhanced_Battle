...
; Characteristics of each move.
    ...
    move RAZOR_WIND,   NO_ADDITIONAL_EFFECT,        65, FLYING,       100, 20 ; replaced 'CHARGE_EFFECT' with 'NO_ADDITIONAL_EFFECT'. passou a ser high-crit. TODO: rethink this move.
    move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, BIRD,         100, 20 ; Natural: arcanine, dragonite, farfetch'd, primeape, persian. Learn: marowak, pinsir, scyther, kabutops, sandslash, kingler, hitmons, etc.
    ...
    move SLAM,         FLINCH_SIDE_EFFECT1,        80,  DRAGON,       100, 20 ; TO REMOVE - DRAGON_SLAM will take its place.
    move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        40, GRASS,        100, 30 ; bellsprout, bulbasaur, tangela - vinewhip; oddish, zubat - absorb.
    move STOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,       100, 20 ; TO REMOVE - GROUND_STOMP will take its place.
    move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING,     100, 20
    move MEGA_KICK,    NO_ADDITIONAL_EFFECT,        85, FIGHTING,      90, 15 ; TO REMOVE.
    move JUMP_KICK,    NO_ADDITIONAL_EFFECT,        85, FIGHTING,      90, 15 ; TO REMOVE.
    ...
    move TAKE_DOWN,    DEFENSE_DOWN1_EFFECT,        80, FIGHTING,      95, 20 ; replaced 'RECOIL_EFFECT' with 'DEFENSE_DOWN1_EFFECT'. versao ligeiramente mais fraca e comum do Submission. TODO: ponderar isto ser Dark type.
    ...
    move GROWL,        ATTACK_DOWN1_EFFECT,          0, BIRD,         100, 30 ; give to oddish, cubone, growlithe.
    move ROAR,         ATTACK_UP1_EFFECT,            0, BIRD,         100, 30 ; replaced 'SWITCH_AND_TELEPORT_EFFECT' with 'ATTACK_UP1_EFFECT'. arcanine, tauros, rhydon, primeape, onyx, snorlax, dragonite, charizard, nidos, gyarados, aerodactyl.
    move SING,         SLEEP_EFFECT,                 0, BIRD,          75, 20 ; jigglypuff, chansey.
    ...
    move DISABLE,      DISABLE_EFFECT,               0, BIRD,          75, 15 ; drowzee, mr mime, jynx.
    ...
    move MIST,         MIST_EFFECT,                  0, ICE,          100, 30 ; TO REMOVE - ICY_MIST will take its place.
    ...
    move HYPER_BEAM,   HYPER_BEAM_EFFECT,          130, DRAGON,        80,  5 ; dragonite, gyarados (high level), mewtwo, mew.
    ...
    move GROWTH,       SPECIAL_UP1_EFFECT,           0, BIRD,         100, 25 ; grass types.
    ...
    move POISONPOWDER, POISON_EFFECT,                0, GRASS,         80, 20 ; venusaur, victreebel, vileplume.
    move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         75, 20 ; victreebel, vileplume.
    move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         70, 20 ; venusaur, vileplume.
    ...
    move RAGE,         ATTACK_UP1_EFFECT,           65, DRAGON,        90, 20 ; replaced 'RAGE_EFFECT' with 'ATTACK_UP1_EFFECT'. gyarados, dragonite, tauros, primeape, marowak, fearow, kangaskhan, etc. Edit: talvez reverter para ter o rage effect, mas mesmo assim aumentar o power e ser dragon type.
    ...
    move MIMIC,        MIMIC_EFFECT,                 0, BIRD,         100, 20 ; mew, golduck, wigglytuff, machamp, porygon.
    ...
    move WITHDRAW,     DEFENSE_UP1_EFFECT,           0, BIRD,         100, 30 ; shellder, squirtle, omanyte.
    move DEFENSE_CURL, DEFENSE_UP1_EFFECT,           0, BIRD,         100, 30 ; geodude, onyx, sandshrew, jigglypuff, hitmonchan, kabuto, ekans, lickitung.
    move BARRIER,      DEFENSE_UP2_EFFECT,           0, BIRD,         100, 20 ; mr mime. TODO: kinda redundant, Mr Mime already has Reflect.
    ...
    move SELFDESTRUCT, EXPLODE_EFFECT,             125, NORMAL,       100,  5 ; weezing, electrode, magneton, porygon, golem, gengar.
    ...
    move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  18, ROCK,          85, 20 ; cloyster, omastar, sandslash. TODO: weird attack, maybe remove.
    ...
    move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, BIRD,         100, 20 ; kadabra's signature move.
    ...
    move POISON_GAS,   POISON_EFFECT,                0, POISON,        80, 20 ; koffing, drowzee, grimer - early level move.
    move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  18, GRASS,         85, 20 ; exeggutor, chansey.
    move LEECH_LIFE,   DRAIN_HP_EFFECT,             75, BUG,          100, 20 ; golbat, parasect, venomoth (?), muk, e kabutops (trocar o kabutops aprender mega drain naturalmente por isto).
    ...
    move BUBBLE,       NO_ADDITIONAL_EFFECT,        25, WATER,        100, 30 ; TO REMOVE.
    move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       65, FIGHTING,     100, 25 ; hitmonchan.
    move SPORE,        SLEEP_EFFECT,                 0, BUG,          100, 20
    move FLASH,        ACCURACY_DOWN1_EFFECT,        0, BIRD,         100, 20 ; TODO: find out how to turn Flash from an HM to a TM.
    ...
    move EXPLOSION,    BURN_SIDE_EFFECT2,          100, FIRE,         100, 10 ; replaced 'EXPLODE_EFFECT' with 'BURN_SIDE_EFFECT2'. electrode, weezing (high level). TODO: confirm that pokemon don't faint on use.
    ...
    move HYPER_FANG,   NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 30 ; replaced 'FLINCH_SIDE_EFFECT1' with 'NO_ADDITIONAL_EFFECT'. passou a ser high-crit.
    move SHARPEN,      ATTACK_UP2_EFFECT,            0, BIRD,         100, 20 ; replaced 'ATTACK_UP1_EFFECT' with 'ATTACK_UP2_EFFECT'. Porygon.
    move CONVERSION,   SPECIAL_UP2_EFFECT,           0, BIRD,         100, 20 ; replaced 'CONVERSION_EFFECT' with 'SPECIAL_UP2_EFFECT'. Porygon.
    move TRI_ATTACK,   ACCURACY_UP1_EFFECT,         90, ELECTRIC,     100, 15 ; replaced 'NO_ADDITIONAL_EFFECT' with 'ACCURACY_UP1_EFFECT'. Porygon, Magneton.
    ...
    ;move GROUND_STOMP, SPEED_DOWN_SIDE_EFFECT,      40, GROUND,       100, 30 ; ADDED: replaced 'FLINCH_SIDE_EFFECT1' with 'SPEED_DOWN_SIDE_EFFECT'. também dar ao Dodrio.
    ;move DRAGON_SLAM,  PARALYZE_SIDE_EFFECT2,       90, DRAGON,       100, 15 ; ADDED: replaced 'NO_ADDITIONAL_EFFECT' with 'PARALYZE_SIDE_EFFECT2'. Natural: onyx, dragonite, gyarados.
    ;move ICY_MIST,     SPEED_DOWN_SIDE_EFFECT,      40, ICE,          100, 30 ; ADDED: replaced 'MIST_EFFECT' with 'SPEED_DOWN_SIDE_EFFECT'.
    ;move BUG_BITE,     FLINCH_SIDE_EFFECT1,         35, BUG,          100, 35 ; ADDED: also give to zubat.
    ;move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT,    75, GHOST,        100, 20 ; ADDED: replaced 'NO_ADDITIONAL_EFFECT' with 'SPECIAL_DOWN_SIDE_EFFECT'. gengar, ninetales, marowak, hypno, jynx. high-level move.
    move STRUGGLE,      RECOIL_EFFECT,               40, BIRD,         100, 10 ; Always have Struggle as the last move on the list (due to Metronome's internal workings). Changed type to Dragon type so it can hit all types, including Ghost.
...
;   8 - Poison Fang: Arbok, Golbat, Nidoking, Nidoqueen, Raticate - POISON_SIDE_EFFECT2. (55/100/25)
...
;   16 - "move SLUDGE_BOMB,       POISON_SIDE_EFFECT2,         90, POISON,       100, 15 ; Natural: muk, weezing, tentacruel, victreebel, vileplume."
;   17 - "move POISON_JAB,        POISON_SIDE_EFFECT2,         90, POISON,       100, 15 ; Natural: beedril, arbok, nidos, golbat, gengar."
;   18 - Charm. Natural: clefairy, jigglypuff, chansey, eevee.
;   19 - Rollout: Golem's signature attack.
;   20 - o Marowak (e outros novos Dark type, tipo Raticate e Arbok aprenderem Pursuit - base 60 dark) aprender um dark type move.
