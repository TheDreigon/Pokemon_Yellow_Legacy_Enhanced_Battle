...
; Characteristics of each move.
    ...
    move RAGE,         ATTACK_UP1_EFFECT,           65, NORMAL,        90, 20 ; replaced 'RAGE_EFFECT' with 'ATTACK_UP1_EFFECT'. gyarados, dragonite, tauros, primeape, marowak, fearow, kangaskhan, etc. Edit: talvez reverter para ter o rage effect, mas mesmo assim aumentar o power e ser dragon type.
