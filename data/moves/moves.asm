...
; Characteristics of each move.
    ...
    move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT,    75, GHOST,        100, 20 ; NEW MOVE - replaced Mega_Kick. Natural: gengar, ninetales, marowak, hypno, jynx. high-level move.
    move DARK_PULSE,   FLINCH_SIDE_EFFECT2,         75, DARK,         100, 20 ; NEW MOVE - replaced Jump_Kick. Natural: Gengar, Hypno, Marowak.
    ...
    move THRASH,       THRASH_PETAL_DANCE_EFFECT,  100, DRAGON,        90, 10 ; gyarados, dragonite, tauros, marowak, primeape, mewtwo.
    ...
    move LEECH_SEED,   LEECH_SEED_EFFECT,            0, GRASS,        100, 15 ; Venusaur, Tangela.
    ...
    move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  100, GRASS,        100, 10 ; venusaur, victreebel, vileplume, Parasect,
    ...
    move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       65, FIGHTING,     100, 25 ; hitmonchan's signature move.
    move SPORE,        SLEEP_EFFECT,                 0, BUG,          100, 20
    move FLASH,        ACCURACY_DOWN1_EFFECT,        0, BIRD,         100, 20 ; TODO: find out how to turn Flash from an HM to a TM. EDIT: nevermind; Smith: "HMs can [now] be forgotten".
    ...
    move EXPLOSION,    BURN_SIDE_EFFECT2,          100, FIRE,         100,  5 ; replaced 'EXPLODE_EFFECT' with 'BURN_SIDE_EFFECT2'. electrode, weezing (high level). TODO: confirm that pokemon don't faint on use.
...
;   15 - "move SLUDGE_BOMB,       POISON_SIDE_EFFECT2,         90, POISON,       100, 15 ; Natural: muk, weezing, tentacruel, victreebel, vileplume."
;   16 - "move POISON_JAB,        POISON_SIDE_EFFECT2,         90, POISON,       100, 15 ; Natural: beedril, arbok, nidos, golbat, gengar."
